...
<body>
	<div class="d-flex align-items-center justify-content-center vh-100">
		<div class="text-center">
			...
			<h4 class="fs-2 fw-bold text-dark mb-3">An uncaught Exception was encounteredsss</h4>

			<p class="text-danger">Type: <?php echo get_class($exception); ?></p>
			<p class="text-danger">Message: <?php echo $message; ?></p>
			<p class="text-danger">Filename: <?php echo $exception->getFile(); ?></p>
			<p class="text-danger">Line Number: <?php echo $exception->getLine(); ?></p>
