<div class="container my-5">
    <h2 class="fs-1 mb-4">Data Transaksi Beli</h2>
    <div class="card card-brutalist p-2">
        <div class="table-responsive">
            <table class="table table-borderless" id="tabelku1" style="margin-bottom: 0;">
                <thead class="font-ui">
                ...
                <tbody>
                    <?php foreach ($transaksi as $k => $v): ?>
                        <tr style="border-bottom: 1px solid var(--color-border);">
                            ...
                            <td class="p-3 align-middle">
                                <a href="<?php echo base_url('transaksi/detail/' . $v['id_transaksi']) ?>" class="btn btn-hw-secondary">Detail</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
