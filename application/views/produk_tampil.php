            ...
            <div class="col-md-8 offset-md-2">
                <form action="<?php echo base_url('produk/cari') ?>" method="get">
                    <div class="input-group">
                        <input type="text" name="keyword" class="form-control form-control-lg" placeholder="KETIK NAMA PRODUK ATAU SERI...">
...
<div class="container my-5">
    <h3 class="fs-2 mb-4">Semua Produk</h3>
    <div class="row">
        <?php if (!empty($produk)): ?>
        ...
        <?php else: ?>
            <div class="col-12">
                <div class="card card-brutalist p-5 text-center">
                    <h4 class="font-ui">BELUM ADA PRODUK YANG TERSEDIA.</h4>
                </div>
            </div>
        <?php endif; ?>
    </div>
