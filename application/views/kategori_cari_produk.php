                ...
                <div class="col-md-8 offset-md-2">
                    <form action="<?php echo base_url('kategori/cari_produk/' . $kategori['id_kategori']) ?>" method="get">
                        <div class="input-group">
                            <input type="text" name="keyword" class="form-control form-control-lg" placeholder="Cari produk di kategori ini..." value="<?php echo htmlspecialchars($keyword, ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <div class="card card-brutalist p-5 text-center">
                        <h4 class="font-ui">
                            <?php if (!empty($keyword)): ?>
                                TIDAK ADA PRODUK YANG COCOK DENGAN PENCARIAN "<?php echo htmlspecialchars($keyword, ENT_QUOTES, 'UTF-8'); ?>"
                            <?php else: ?>
