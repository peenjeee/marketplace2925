            ...
            <div class="col-md-8 offset-md-2">
                <form action="<?php echo base_url('artikel/cari') ?>" method="get">
                    <div class="input-group">
                        <input type="text" name="keyword" class="form-control form-control-lg" placeholder="KETIK JUDUL ATAU KONTEN..." value="<?php echo htmlspecialchars($keyword) ?>">
        ...
        <?php else: ?>
            <div class="col-12">
                <div class="card card-brutalist p-5 text-center">
                    <h4 class="font-ui">TIDAK ADA ARTIKEL YANG DITEMUKAN</h4>
