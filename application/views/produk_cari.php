...
<section class="py-5" style="background-color: var(--color-accent-flame);">
    <div class="container">
        <h2 class="text-center fs-1 text-white" style="text-shadow: 2px 2px 0px var(--color-text);">Cari Produk</h2>
        <div class="row mt-4">
            <div class="col-md-8 offset-md-2">
                <form action="<?php echo base_url('produk/cari') ?>" method="get">
                    <div class="input-group">
                        <input type="text" name="keyword" class="form-control form-control-lg" placeholder="KETIK NAMA PRODUK ATAU SERI..." value="<?php echo htmlspecialchars($keyword) ?>">
        ...
        <?php else: ?>
            <div class="col-12">
                <div class="card card-brutalist p-5 text-center">
                    <h4 class="font-ui">TIDAK ADA PRODUK YANG DITEMUKAN.</h4>
