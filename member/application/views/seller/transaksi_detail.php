            ...
            <div class="col-md-3">
                ...
                <form method="post">
                    <div class="input-group">
                        ...
                        <span class="text-danger small fst-italic mt-1"><?php echo form_error('resi_ekspedisi'); ?></span>
...
<?php else: ?>
    ...
    <div class="d-flex justify-content-center mt-5">
        <a href="<?= base_url('seller/transaksi'); ?>" class="btn btn-primary btn-neoraised fw-bold">Kembali</a>
    </div>
<?php endif; ?>